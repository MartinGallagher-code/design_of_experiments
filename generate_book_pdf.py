#!/usr/bin/env python3
"""Generate a 6×9 inch PDF book suitable for Lulu.com from the DOE Helper website content.
...
<style>
/* ── Page setup: 6×9 inch for Lulu.com ── */
@page {{
  size: 6in 9in;
...
/* ── Code ── */
code {{
  font: 500 8.5pt/1.4 'JetBrains Mono', 'Consolas', monospace;
  background: #f3f4f6;
  padding: 0.5pt 3pt;
  border-radius: 2pt;
...
.code-header {{
  background: #252540;
  padding: 4pt 10pt;
  font: 500 7pt 'JetBrains Mono', monospace;
  color: #888;
}}
.code-body {{
  padding: 8pt 10pt;
  font: 400 7.5pt/1.55 'JetBrains Mono', monospace;
  color: #d4d4d4;
  white-space: pre-wrap;
  word-break: break-all;
}}
...
thead th {{
  ...
  padding: 5pt 6pt;
  text-align: left;
  font: 600 7.5pt 'JetBrains Mono', monospace;
...
.flag-table td {{ padding: 4pt 6pt; font-size: 8pt; }}
