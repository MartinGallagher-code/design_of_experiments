...
```bash
python doe.py info --config use_cases/06_distillation_column/config.json
```
...
```bash
python doe.py generate --config use_cases/06_distillation_column/config.json \
...
```bash
python doe.py analyze --config use_cases/06_distillation_column/config.json
```
...
```bash
python doe.py optimize --config use_cases/06_distillation_column/config.json \
...
```bash
python doe.py report --config use_cases/06_distillation_column/config.json \
