...
python doe.py info --config use_cases/07_mpi_collective_tuning/config.json
python doe.py generate --config use_cases/07_mpi_collective_tuning/config.json \
    --output use_cases/07_mpi_collective_tuning/results/run.sh --seed 42
bash use_cases/07_mpi_collective_tuning/results/run.sh
python doe.py analyze --config use_cases/07_mpi_collective_tuning/config.json
python doe.py report --config use_cases/07_mpi_collective_tuning/config.json \
