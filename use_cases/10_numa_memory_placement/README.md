...
python doe.py generate --config use_cases/10_numa_memory_placement/config.json \
...
python doe.py report --config use_cases/10_numa_memory_placement/config.json \
