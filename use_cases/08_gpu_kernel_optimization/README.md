...
python doe.py info --config use_cases/08_gpu_kernel_optimization/config.json
python doe.py generate --config use_cases/08_gpu_kernel_optimization/config.json \
...
python doe.py analyze --config use_cases/08_gpu_kernel_optimization/config.json
python doe.py report --config use_cases/08_gpu_kernel_optimization/config.json \
