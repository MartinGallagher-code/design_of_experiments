...
```bash
python doe.py info --config use_cases/04_database_performance_tuning/config.json
```
...
```bash
python doe.py generate --config use_cases/04_database_performance_tuning/config.json \
...
```bash
python doe.py analyze --config use_cases/04_database_performance_tuning/config.json --no-plots
```
...
```bash
python doe.py analyze --config use_cases/04_database_performance_tuning/config.json \
...
```bash
python doe.py optimize --config use_cases/04_database_performance_tuning/config.json
```

### Step 7: Generate report

```bash
python doe.py report --config use_cases/04_database_performance_tuning/config.json \
