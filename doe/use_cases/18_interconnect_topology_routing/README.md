...
doe info --config use_cases/18_interconnect_topology_routing/config.json
doe generate --config use_cases/18_interconnect_topology_routing/config.json \
...
doe analyze --config use_cases/18_interconnect_topology_routing/config.json
doe report --config use_cases/18_interconnect_topology_routing/config.json \
